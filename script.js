(function() {
  ...
  const langData = {
    id: {
      ...
      musicLabel: "🎵 Putar Lagu",
      musicLabelPlaying: "🎵 ⏸ Jeda",
      waMessage: "Halo Frankie & Secilia, saya ingin mengucapkan selamat atas pernikahan kalian! Kiranya Tuhan memberkati keluarga baru ini. 🙏"
    },
    en: {
      ...
      musicLabelPlaying: "🎵 ⏸ Pause",
      waMessage: "Hello Frankie & Secilia, congratulations on your wedding! May God bless your new family. 🙏"
    },
    es: {
      heroTitle: "Santo Matrimonio",
      heroSub: "En el Amor de Cristo",
      quoteText: "Lo que Dios ha unido, que no lo separe el hombre.",
      locLabel: "Ubicación de la Misa de Bodas",
      locValue: "Iglesia St. Yohanes Rasul Delanggu",
      locSub: "Delanggu, Klaten",
      dateLabel: "Día y Hora",
      dateValue: "Sábado, 17 de Octubre de 2026",
      timeText: "10.30 WIB",
      mapLabel: "Iglesia St. Yohanes Rasul",
      rsvpText1: "Enviar a Frankie",
      rsvpText2: "Enviar a Secilia",
      footerText: "Ofrecido en el amor de Cristo",
      footerChurch: "Iglesia St. Yohanes Rasul · Delanggu",
      paduanBtnLabel: "📖 Abrir Guía de Misa",
      musicLabel: "🎵 Reproducir Música",
      musicLabelPlaying: "🎵 ⏸ Pausa",
      waMessage: "Hola Frankie y Secilia, ¡felicidades por su boda! Que Dios bendiga su nueva familia. 🙏"
    }
  };

  // ===================== DATA PADUAN MISA (INDONESIA - LENGKAP) =====================
  const paduanDataId = `
    <h3>RITUS PEMBUKA</h3>
    ...
    <p><strong>I:</strong> Selamat datang, Frankie dan Secilia. Selamat datang juga bagi para orang tua dan kerabat. Mempelai yang berbahagia, kami menyambut kalian di sini, hendak ikut bersyukur dan menyaksikan peneguhan cinta kalian di hadapan Allah. Semoga peristiwa indah ini akan menjadi kenangan penuh rahmat dalam hidup kalian. Marilah kita bersama-sama menuju ke depan altar Tuhan.</p>
    <p><em>→ PERARAKAN</em></p>

    <p><strong>Cara B — Dengan permohonan keluarga:</strong></p>
    <p><strong>I:</strong> Selamat datang, Saudara-saudari yang dikasihi Tuhan. Kita berhimpun di sini untuk mengawali perayaan perkawinan Frankie dan Secilia. Gereja menyambut Saudara-saudari dan ikut bergembira dalam perayaan kasih ini.</p>
    <p><strong>Wakil Keluarga:</strong> Rama yang terhormat, seluruh keluarga Frankie dan Secilia hendak mengantar Frankie dan Secilia memasuki hidup perkawinan. Kami mohon agar perkawinan mereka dikukuhkan dan diberkati sesuai dengan ajaran dan tata perayaan Gereja Katolik.</p>
    ...
    <p>Setelah memerciki, Imam kembali ke tempat duduknya. Kemudian dapat dinyanyikan Madah Kemuliaan, kecuali jika perayaan ini diadakan dalam masa Adven dan masa Prapaskah.</p>

    <h4>DOA PEMBUKA</h4>
    <p><em>Umat berdiri</em></p>
    <p>Jika Perayaan Perkawinan dilakukan dalam Misa pada hari/masa yang disebut di atas (bukan Misa bagi Mempelai), maka Doa Pembuka, Doa Persiapan Persembahan, dan Doa Sesudah Komuni diambil dari rumus Misa hari yang bersangkutan. Dalam Misa bagi Mempelai, Doa Pembuka dapat memakai contoh berikut ini. Atau contoh pilihan lain dalam Lampiran I, nomor 350-355.</p>
    ...
    <p>Jika tidak dirayakan Misa bagi Mempelai, salah satu bacaan dapat diambil dari <em>Buku Bacaan Misa</em> khusus untuk perkawinan, kecuali dalam Misa Natal, Epifani, Paskah, Kenaikan Tuhan, Pentakosta, Tubuh dan Darah Kristus, atau Misa dengan tingkat Hari Raya lainnya. Hendaknya dipilih bacaan yang menyatakan pentingnya nilai dan martabat perkawinan dalam misteri keselamatan.</p>

    <h4>PILIHAN BACAAN</h4>
    <p>Pembacaan dilakukan seperti lazimnya. Berikut ini contoh pilihan Bacaan-bacaannya. Pilihan lain dapat dilihat pada Lampiran I, nomor 305-348.</p>
    ...
    <p><strong>I:</strong> Frankie dan Secilia, sebelum perayaan perkawinan Gereja kita laksanakan, kami persilakan kalian berdua terlebih dahulu menghadap kedua orang tua kalian untuk mohon restu bagi perjalanan hidup yang hendak kalian awali ini.</p>
    ...
    <p>Untuk kedua mempelai yang salah satu tidak dibaptis:</p>
    <p><strong>I:</strong> Mempelai yang berbahagia, kalian datang di tempat ini karena berniat untuk saling mengikat diri dalam hidup perkawinan yang akan diteguhkan dengan meterai suci. Di hadapan pelayan Gereja dan umat beriman, semoga cinta kalian berdua diperkaya dengan berkat Tuhan, demi kesetiaan abadi satu sama lain.</p>
    ...
    <p><strong>I:</strong> Frankie dan Secilia, sungguhkah kalian dengan hati bebas dan tulus ikhlas hendak meresmikan perkawinan ini?</p>
    ...
    <p>Pertanyaan berikut dapat dihilangkan jika dianggap tidak cocok dengan keadaan mempelai.</p>
    ...
    <p><strong>Frankie:</strong> Saya, Frankie, memilih engkau, Secilia, menjadi istri saya. Saya berjanji untuk setia mengabdikan diri kepadamu dalam untung dan malang, di waktu sehat dan sakit. Saya mau mengasihi dan menghormati engkau sepanjang hidup saya.</p>
    <p><strong>Secilia:</strong> Saya, Secilia, memilih engkau, Frankie, menjadi suami saya. Saya berjanji untuk setia mengabdikan diri kepadamu dalam untung dan malang, di waktu sehat dan sakit. Saya mau mengasihi dan menghormati engkau sepanjang hidup saya.</p>
    ...
    <p>Janji Perkawinan mempelai laki-laki:</p>
    <p><strong>I:</strong> Frankie, maukah Anda menerima Secilia menjadi istrimu dan berjanji setia mengabdikan diri kepadanya dalam untung dan malang, di waktu sehat dan sakit, serta mau mengasihi dan menghormati dia sepanjang hidupmu?</p>
    <p><strong>Frankie:</strong> Ya, saya mau.</p>
    <p>Janji Perkawinan mempelai perempuan:</p>
    <p><strong>I:</strong> Secilia, maukah Anda menerima Frankie menjadi suamimu dan berjanji setia mengabdikan diri kepadanya dalam untung dan malang, di waktu sehat dan sakit, serta mau mengasihi dan menghormati dia sepanjang hidupmu?</p>
    <p><strong>Secilia:</strong> Ya, saya mau.</p>
    ...
    <p>Imam memberkati cincin kedua mempelai, misalnya dengan salah satu rumus berkat berikut:</p>
    ...
    <p><strong>Frankie:</strong> Secilia, terimalah cincin ini, tanda cintaku dan kesetiaanku. (jika mempelai Katolik ditambahkan:) Dalam nama Bapa dan Putra dan Roh Kudus.</p>
    <p><strong>Secilia:</strong> Frankie, terimalah cincin ini, tanda cintaku dan kesetiaanku. (jika mempelai Katolik ditambahkan:) Dalam nama Bapa dan Putra dan Roh Kudus.</p>
    ...
    <p><strong>I:</strong> Frankie dan Secilia, sekarang saya persilakan kalian berdua memohon restu kedua orang tuamu demi perjalanan hidup yang sudah kalian awali ini.</p>
    <p>Kedua mempelai menghadap orang tua mereka. Sementara itu dapat diiringi nyanyian yang sesuai dengan maksud ritus ini. Bagi wilayah adat yang biasa mengisi ungkapan restu orang tua dengan kata-kata dan nasihat, nyanyian dapat ditiadakan.</p>
    ...
    <h4>SYAHADAT</h4>
    <p><em>Umat berdiri</em></p>
    <p>Dalam Misa Hari Minggu atau yang setingkat dengan Hari Raya diadakan juga pengakuan iman bersama (Syahadat). Namun, dalam Misa bagi Mempelai tidak perlu diadakan.</p>

    <h4>DOA UMAT</h4>
    <p><em>Umat berdiri</em></p>
    <p>Imam mengajak dan memimpin umat untuk menyampaikan doa-doa mereka, misalnya seperti di bawah ini. Contoh lainnya dapat dilihat pada Lampiran I, nomor 358-359. Kedua mempelai tidak diberi tugas untuk membawakan Doa Umat.</p>
    <p><strong>I:</strong> Saudara-saudari terkasih, Tuhan telah berkenan menyempurnakan dan menguduskan cinta Frankie dan Secilia, maka sambil mengenangkan anugerah kebaikan dan cinta istimewa yang telah mereka terima marilah kita menyerahkan mereka kepada Tuhan melalui doa-doa ini.</p>
    <p><strong>L:</strong> Semoga Frankie dan Secilia, yang baru saja dipersatukan dalam perkawinan suci, selalu dikaruniai kesehatan jiwa dan raga. Marilah kita mohon.</p>
    ...
    <p><strong>I:</strong> Maka kami mohon, ya Tuhan, sudilah menerima persembahan kami, hamba-hamba-Mu, dan persembahan seluruh keluarga-Mu ini. Kami mempersembahkannya juga untuk hamba-hamba-Mu, Frankie dan Secilia ini. Sebagaimana Engkau telah mengantar mereka sampai pada hari perkawinan mereka; [semoga Engkau menggembirakan mereka dengan anugerah keturunan] dan memberkati mereka dengan usia panjang. Dengan pengantaraan Kristus, Tuhan kami.</p>
    <p><strong>U:</strong> Amin.</p>

    <p><strong>Sisipan dalam Doa Syukur Agung II:</strong></p>
    <p><strong>I:</strong> Ingatlah juga, ya Tuhan, akan hamba-hamba-Mu, Frankie dan Secilia ini, yang telah Engkau antar sampai pada hari perkawinan ini. Semoga dengan bantuan rahmat-Mu mereka saling mencintai dan hidup rukun.</p>

    <p><strong>Sisipan dalam Doa Syukur Agung III:</strong></p>
    <p><strong>I:</strong> Kami mohon, teguhkanlah dalam rahmat perkawinan hamba-hamba-Mu, Frankie dan Secilia, yang telah Engkau antar dengan sukacita sampai pada hari perkawinan ini. Semoga janji yang mereka ikrarkan di hadapan-Mu senantiasa mereka pelihara selama hidup di dalam naungan-Mu.</p>
    ...
    <p><em>Hening</em></p>
    <p>Imam merentangkan kedua tangannya di atas mempelai dan mengucapkan doa berikut. Kalimat dalam tanda kurung dapat dilewati jika memang tidak sesuai dengan keadaan mempelai.</p>
    ...
    <h4>PENGUTUSAN</h4>
    <p><em>Umat berdiri</em></p>
    <p><strong>I:</strong> Saudara-saudari terkasih, dengan ini perayaan Ekaristi dan Perkawinan Frankie dan Secilia sudah selesai.</p>
    <p><strong>U:</strong> Syukur kepada Allah.</p>
    ...
    <p><strong>Frankie:</strong> Santa Maria, Bunda Yesus dan Bunda kami yang tercinta, hari ini hari yang sangat membahagiakan kami berdua. Kami telah berjanji untuk saling setia dan kami mau menempuh perjalanan hidup selanjutnya bersama-sama sebagai suami istri. Pada saat yang sungguh berarti ini kami memohon juga doa restumu, ya Bunda kami.</p>
    <p><strong>Secilia:</strong> Santa Maria, doakanlah kami, agar cinta kami tahan uji dalam segala suka dan duka hidup perkawinan. Semoga kami dapat membentuk rumah tangga yang sejahtera dan membangun keluarga yang bahagia. Ya Bunda yang baik hati, doakanlah kami pada Putra-Mu, Tuhan kami, Yesus Kristus.</p>
  ...
  // ===================== DATA PADUAN MISA (SPANYOL - LENGKAP) =====================
  const paduanDataEs = `
    ...
    <p>Los novios y su séquito se reúnen frente a la puerta de la iglesia. El sacerdote los recibe con vestimenta litúrgica blanca, acompañado por los acólitos. El sacerdote puede rociar agua bendita sobre ellos y sus familiares. Si no se realiza la aspersión en este momento, puede hacerse después de la Monición de Entrada para sustituir el Acto Penitencial. Al rociarlos, el sacerdote puede decir:</p>
    <p><strong>P:</strong> Que Dios os conceda gracia y bendición, para que os presentéis ante Él con corazón puro.</p>
    <p>Luego el sacerdote los saluda cordialmente, manifestando que la Iglesia comparte su alegría. Se puede elegir una de las siguientes maneras:</p>

    <p><strong>Manera A — Sin petición de la familia:</strong></p>
    <p><strong>P:</strong> Bienvenidos, Frankie y Secilia. Bienvenidos también padres y familiares. Novios felices, os acogemos aquí para dar gracias y ser testigos de la confirmación de vuestro amor ante Dios. Que este hermoso acontecimiento sea un recuerdo lleno de gracia en vuestra vida. Vayamos juntos hacia el altar del Señor.</p>
    <p><em>→ PROCESIÓN</em></p>

    <p><strong>Manera B — Con petición de la familia:</strong></p>
    <p><strong>P:</strong> Bienvenidos, queridos hermanos y hermanas. Nos reunimos aquí para comenzar la celebración del matrimonio de Frankie y Secilia. La Iglesia os acoge y se alegra con vosotros en esta celebración de amor.</p>
    <p><strong>Familia:</strong> Reverendo Padre, toda la familia de Frankie y Secilia desea acompañar a Frankie y Secilia a iniciar la vida matrimonial. Rogamos que su matrimonio sea confirmado y bendecido según la enseñanza y la tradición de la Iglesia Católica.</p>
    <p><strong>P:</strong> Que el Señor acepte vuestro deseo y esperanza. Vayamos juntos hacia el altar del Señor.</p>
    <p>O:</p>
    <p><strong>P:</strong> Ahora, entremos en la casa del Señor y entreguemos a Él todas nuestras esperanzas y oraciones. Que podamos experimentar el amor fiel del Señor que nos vivifica y santifica, su pueblo.</p>
    ...
    <p>Ante el altar hacen una reverencia profunda. El sacerdote se dirige al altar, lo besa y luego va a su lugar.</p>
    ...
    <p><em>Asamblea de pie</em></p>
    <p><strong>P:</strong> Queridos hermanos y hermanas, especialmente la familia y amigos de los novios, con gran alegría nos reunimos en la casa del Señor junto a Frankie y Secilia que hoy desean confirmar su amor en el santo matrimonio. Para ellos este día es muy especial. Escucharemos la Palabra de Dios, dirigida a ellos y también a todos nosotros. Acompañemos sus deseos con oraciones sinceras. Que Dios bendiga la familia que comenzarán a construir hoy.</p>

    <h4>ASPERSIÓN / ORACIÓN DE APERTURA</h4>
    <p><strong>P:</strong> Frankie y Secilia, junto con vuestros padres, familiares y amigos, la Iglesia se alegra y os recibe con cariño en este momento tan significativo de vuestra vida. El Señor os ayuda en este día feliz. Tiende su mano desde el cielo y os protege a ambos. Os concede y colma todas las peticiones que esperáis.</p>
    ...
    <p>Se puede añadir un saludo a los presentes que no son católicos:</p>
    <p><strong>P:</strong> Hermanos y hermanas que no son católicos, les agradecemos su presencia en esta celebración. Este matrimonio se celebrará según el rito de la Iglesia Católica. También pedimos su apoyo con oraciones durante esta santa celebración.</p>

    <h4>ASPERSIÓN</h4>
    <p><em>Asamblea de pie</em></p>
    <p><strong>P:</strong> Queridos hermanos y hermanas, estamos celebrando el gran misterio del amor de Cristo a la Iglesia. Hoy Frankie y Secilia son llamados a participar en este misterio a través de su matrimonio. Todos estamos unidos en la fe en Cristo, don de Dios derramado en nuestros corazones y profesado en el bautismo. Recordemos, pues, nuestro bautismo, inicio de la vida nueva en la fe, fuente y fundamento de toda vocación cristiana.</p>
    ...
    <p>La Liturgia de la Palabra se celebra como de costumbre. Puede haber dos o tres lecturas. La primera lectura debe tomarse del Antiguo Testamento, pero en tiempo de Pascua del Libro de los Hechos de los Apóstoles o del Apocalipsis. Al menos una de las lecturas debe hablar específicamente del matrimonio.</p>

    <h4>LECTURAS</h4>
    <p><strong>Primera Lectura</strong> — Génesis 1:26-28, 31a:</p>
    <p><em>"Los creó varón y mujer."</em></p>
    <p>Dijo Dios: Hagamos al hombre... y vio que era muy bueno.</p>
    ...
    <p>O:</p>
    <p><strong>Estribillo:</strong> (4) Así será bendecido el hombre que teme al Señor.</p>

    <p><strong>Segunda Lectura</strong> — Efesios 5:2a, 21-33 (extensa) o 5:2a, 25-32 (breve):</p>
    <p><em>"Grande es este misterio, pero yo me refiero a Cristo y a la Iglesia."</em></p>
    <p>Hermanos: Vivan en el amor, como Cristo nos amó y se entregó a sí mismo por nosotros... sométanse unos a otros.</p>

    <p><strong>Aclamación del Evangelio</strong> — Salmo 133 (134):3</p>
    <p><strong>Aleluya:</strong> Que el Señor te bendiga desde Sion.</p>
    <p>O: (para tiempo de Cuaresma) — 1Juan 4:16b, 12, 11</p>
    <p><strong>Aclamación:</strong> Alabado seas, Cristo, Rey de gloria y eternidad.</p>
    <p><strong>Verso:</strong> Dios es amor, amémonos unos a otros como Dios nos ha amado.</p>

    <p><strong>Evangelio</strong> — Mateo 19:3-6:</p>
    <p><em>"Lo que Dios ha unido, que no lo separe el hombre."</em></p>
    <p>En aquel tiempo, se acercaron a Jesús unos fariseos...</p>

    <h4>HOMILÍA</h4>
    <p><em>Asamblea sentada</em></p>
    <p>El sacerdote explica el misterio del matrimonio cristiano, la dignidad del amor conyugal, la gracia del sacramento y sus obligaciones, relacionándolo con la situación real de los novios y el contexto actual.</p>

    <h3>CELEBRACIÓN DEL MATRIMONIO</h3>
    <p><em>Asamblea sentada</em></p>
    <p>Si hay dos o más parejas, la Declaración, el Consentimiento y la Aceptación se realizan por cada pareja. Los demás ritos se hacen una sola vez para todos.</p>

    <h4>PEDIR LA BENDICIÓN DE LOS PADRES</h4>
    <p><em>Asamblea sentada</em></p>
    <p><strong>P:</strong> Frankie y Secilia, antes de celebrar el sacramento del matrimonio, os invitamos a acercaros a vuestros padres para pedir su bendición para el camino que vais a iniciar.</p>

    <h4>DECLARACIÓN DE LOS NOVIOS</h4>
    <p><strong>P:</strong> Frankie y Secilia, ¿venís libremente y con sincero corazón a contraer matrimonio?</p>
    ...
    <p><strong>Frankie:</strong> Yo, Frankie, te recibo a ti, Secilia, como mi esposa. Prometo serte fiel en la prosperidad y en la adversidad, en la salud y en la enfermedad, y amarte y respetarte todos los días de mi vida.</p>
    <p><strong>Secilia:</strong> Yo, Secilia, te recibo a ti, Frankie, como mi esposo. Prometo serte fiel en la prosperidad y en la adversidad, en la salud y en la enfermedad, y amarte y respetarte todos los días de mi vida.</p>

    <p><strong>Manera B — En forma de preguntas</strong></p>
    <p><strong>P:</strong> Frankie, ¿aceptas a Secilia como tu esposa y prometes serle fiel en la prosperidad y en la adversidad, en la salud y en la enfermedad, y amarla y respetarla todos los días de tu vida?</p>
    <p><strong>Frankie:</strong> Sí, acepto.</p>
    <p><strong>P:</strong> Secilia, ¿aceptas a Frankie como tu esposo y prometes serle fiel en la prosperidad y en la adversidad, en la salud y en la enfermedad, y amarlo y respetarlo todos los días de tu vida?</p>
    <p><strong>Secilia:</strong> Sí, acepto.</p>
    ...
    <p><strong>Fórmula C:</strong></p>
    <p><strong>P:</strong> En nombre de la Iglesia de Dios, ante los testigos y el pueblo de Dios aquí presentes, confirmo que este matrimonio es un matrimonio católico válido. Que este Sacramento sea para vosotros fuente de fortaleza y felicidad. Lo que Dios ha unido, que no lo separe el hombre.</p>
    <p><strong>A:</strong> Amén.</p>
    <p><strong>P:</strong> Alabemos al Señor.</p>
    <p><strong>A:</strong> Demos gracias a Dios.</p>
    ...
    <p><strong>A:</strong> Amén.</p>
    <p><strong>Frankie:</strong> Secilia, recibe este anillo como señal de mi amor y fidelidad. (si es católico:) En el nombre del Padre, del Hijo y del Espíritu Santo.</p>
    <p><strong>Secilia:</strong> Frankie, recibe este anillo como señal de mi amor y fidelidad. (si es católica:) En el nombre del Padre, del Hijo y del Espíritu Santo.</p>
    ...
    <p>O:</p>
    <p><strong>P:</strong> Señor, bendice y santifica a tus siervos en su amor. Que estos anillos sean para ellos señal de fidelidad y recuerdo para amarse mutuamente. Por Cristo, nuestro Señor.</p>
    <p><strong>A:</strong> Amén.</p>
    ...
    <p><em>Asamblea de pie</em></p>
    <p><strong>P:</strong> Queridos hermanos y hermanas, el Señor se ha dignado perfeccionar y santificar el amor de Frankie y Secilia, por eso, recordando el don de bondad y amor especial que han recibido, presentémoslos al Señor con estas oraciones.</p>
    <p><strong>L:</strong> Para que Frankie y Secilia, recién unidos en santo matrimonio, sean siempre bendecidos con salud de alma y cuerpo. Roguemos al Señor.</p>
    ...
    <p><strong>A:</strong> Señor, escúchanos.</p>
    <p><strong>L:</strong> Para que el pueblo de Dios crezca cada día en virtud y todos los que están cargados encuentren fortaleza en la santa gracia de Dios. Roguemos al Señor.</p>
    <p><strong>A:</strong> Señor, escúchanos.</p>
    <p><strong>L:</strong> Para que la gracia del Sacramento del Matrimonio de todas las parejas aquí presentes sea renovada por el Espíritu Santo. Roguemos al Señor.</p>
    <p><strong>A:</strong> Señor, escúchanos.</p>
    ...
    <p><strong>Inserciones en la Plegaria Eucarística I:</strong></p>
    <p><strong>P:</strong> Te rogamos, Señor, acepta esta ofrenda de tus siervos y de toda tu familia. La ofrecemos también por tus siervos Frankie y Secilia. Así como los has guiado hasta el día de su boda, [concédeles la alegría de la descendencia] y bendícelos con larga vida. Por Cristo, nuestro Señor.</p>
    <p><strong>A:</strong> Amén.</p>

    <p><strong>Inserciones en la Plegaria Eucarística II:</strong></p>
    <p><strong>P:</strong> Acuérdate también, Señor, de tus siervos Frankie y Secilia, a quienes has guiado hasta este día de su boda. Que con tu gracia se amen y vivan en armonía.</p>

    <p><strong>Inserciones en la Plegaria Eucarística III:</strong></p>
    <p><strong>P:</strong> Te rogamos, confirma en la gracia del matrimonio a tus siervos Frankie y Secilia, a quienes has guiado con alegría hasta este día de su boda. Que la promesa que han hecho ante Ti la mantengan siempre bajo tu protección.</p>
    ...
    <p>Dios, en ti la mujer se une al hombre, y la primera comunidad humana, la familia, ha sido bendecida con una bendición que nada puede anular: ni la maldición del pecado original ni el diluvio.</p>
    <p>Mira con bondad a estos siervos tuyos que, al contraer matrimonio, esperan tu bendición y protección. Derrama sobre ellos el don del Espíritu Santo, para que sean fieles en el vínculo conyugal por el amor que has infundido en sus corazones.</p>
    <p>Llena el corazón de Secilia, la esposa, con la gracia del amor y la paz. Que siga el ejemplo de las mujeres santas alabadas en la Escritura. Que el corazón de su esposo descanse en ella y sea aceptada como compañera digna. Que lo acompañe con respeto y lo ame siempre, con el amor de Cristo que ama a su Iglesia.</p>
    ...
    <h4>DESPEDIDA</h4>
    <p><em>Asamblea de pie</em></p>
    <p><strong>P:</strong> Queridos hermanos, la Eucaristía y el Matrimonio de Frankie y Secilia han concluido.</p>
    <p><strong>A:</strong> Demos gracias a Dios.</p>
    ...
    <p><strong>Frankie:</strong> Santa María, Madre de Jesús y Madre nuestra amada, hoy es un día muy feliz para nosotros. Hemos prometido fidelidad mutua y queremos recorrer juntos el camino de la vida como esposos. En este momento tan significativo, te pedimos también tu bendición, Madre nuestra.</p>
    <p><strong>Secilia:</strong> Santa María, intercede por nosotros para que nuestro amor sea fuerte en las alegrías y dificultades del matrimonio. Que podamos formar un hogar próspero y una familia feliz. Buena Madre, intercede por nosotros ante tu Hijo, nuestro Señor Jesucristo.</p>
  ...
  const WA_NUMBER_2 = '6281353011386';  // Nomor Secilia
  ...
  window.toggleMusic = function() {
    if (isPlaying) {
      ...
      const currentLang = document.querySelector('.lang-btn.active')?.dataset.lang || 'id';
      musicLabel.textContent = langData[currentLang].musicLabel;
    } else {
      ...
      const currentLang = document.querySelector('.lang-btn.active')?.dataset.lang || 'id';
      musicLabel.textContent = langData[currentLang].musicLabelPlaying;
    }
  };

  // Update music label saat berganti bahasa
  function updateMusicLabel(lang) {
    if (isPlaying) {
      musicLabel.textContent = langData[lang].musicLabelPlaying;
    } else {
      musicLabel.textContent = langData[lang].musicLabel;
    }
  }
  ...
  openPaduanBtn.addEventListener('click', function() {
    ...
    const activeLang = document.querySelector('.lang-btn.active')?.dataset.lang || 'id';
    if (activeLang === 'es') {
      setModalPaduan('es');
    } else {
      setModalPaduan('id');
  ...
  // Autoplay musik (perlu interaksi user pertama)
